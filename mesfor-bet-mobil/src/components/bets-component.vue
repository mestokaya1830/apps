    ...
    <div class="mobil-con">
      ...
      <div>
        <div class="bet-menu bet-menu-mobil bet-menu-search">
          <span class="cl-y mr10">{{ title }}</span>
          <span class="cl-y">({{ betSummary.length }})</span>
          <input v-model="searchBox" type="number" class="search-1 ml10" placeholder="Kod Ara..."
          @keyup.enter="search()" />
          <img src="@/assets/img/calendar.webp" alt="" @click="openCalendar()" class="menu-icons mr10 ml10">
          <span>
            <img src="@/assets/img/switch.webp" alt="" @click="isBetOpen =! isBetOpen" title="Aç Kapa" class="menu-icons mt5 cl-y cp"/>
          </span>
        </div>
        <header class="filter-menu-admin">
          <div v-if="$route.name == 'bets'">
            <select class="select-1" v-if="role != 'Member'" v-model="userBox" @change="getBetSummary()">
            ...
            <div v-if="role != 'Boss'">
              ...
              <select v-model="weekDate" @change="weekFilter()" class="select-1">
              ...
              <div>
                ...
                <select v-if="role != 'Boss'" v-model="stateBox" @change="getBetSummary()" class="select-1">
        ...
        <div v-else class="bet-summary-con-mobil-admin">
